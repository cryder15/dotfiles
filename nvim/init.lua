--[[
  ...
  A modular, well-organized Neovim setup with custom plugins and configurations.
  
  Quick Start:
  - Leader key is <space>
  - Use `:help` for built-in documentation
  - Use `<space>sh` to search help documentation
  - Use `:checkhealth` if you encounter any issues
  
  Configuration is split into:
  - init.lua: Core settings and main plugin setup
...
require('lazy').setup({
  ...
  -- Simple plugins are automatically loaded from lua/plugins/
  ...
  },
  {
    ...
    config = function()
      ...
      require('mason-lspconfig').setup {
        ensure_installed = {}, -- Add LSP servers you want to auto-install here
  ...
  -- Each file should return a plugin configuration table
